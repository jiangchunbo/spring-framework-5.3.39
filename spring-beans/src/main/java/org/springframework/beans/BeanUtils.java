...
public abstract class BeanUtils {
	 ...
	 *
	 * 根据 "Editor" 后缀命名规范(约定)查找对应 JavaBeans 的 PropertyEditor。
	 * 例如 mypackage.MyDomainClass 对应查找 mypackage.MyDomainClassEditor
	 *
	 * 词方法兼容 java.beans.PropertyEditorManager 所实现的标准 JavaBeans 规范，
	 * 但与之不同的是，它将查找范围与后者为基本类型注册的默认编辑器隔离开来。
	 *
	...
	public static PropertyEditor findEditorByConvention(@Nullable Class<?> targetType) {
		...
		// 硬编码 PropertyEditor 等于 targetType 全类名 + Editor
