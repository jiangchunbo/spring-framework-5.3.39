 ...
 * <p>
 * 策略接口，用于确定是否给定的 bean definition 有资格作为特定依赖的 autowire 候选者
 * <p>
 * 这个接口有点像 Helper
 *
...
public interface AutowireCandidateResolver {
	 ...
	 * <p>
	 * 判断是否给定的 [descriptor] 声明了除了类型之外的限定符
	 * <p>
	 * 一般按照类型找到多个，可以用限定符进一步区分 candidate
	 *
	 * @param descriptor the descriptor for the target method parameter or field
	 ...
	 * <p>The default implementation simply returns {@code null}.
	 * <p>
	 * 如果这个依赖注入项需要惰性解析，那么返回代理对象，否则返回 null。
	 *
	 * @param descriptor the descriptor for the target method parameter or field
