...
public abstract class AnnotationUtils {
	...
	public static AnnotationAttributes getAnnotationAttributes(
		...
		// annotation 				Java 注解对象
		// classValuesAsString  	是否将 Class 转换为 string
		// nestedAnnotationsAsMap	是否将嵌套注解转换到 AnnotationAttributes
	...
	public static AnnotationAttributes getAnnotationAttributes(
		...
		// annotatedElement 注解出现在哪个元素上，可能是 null，也就是直接传了个注解对象
